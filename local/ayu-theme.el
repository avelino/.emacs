;;; ayu-theme.el --- 🎨🖌 Modern theme

;; Copyright 2018, All rights reserved
;;
;; Code licensed under the MIT license
;; https://github.com/dempfi/ayu/blob/master/LICENSE

;; Author: Avelino <t@avelino.xxx>
;; Version: 1.0.0
;; Package-Requires: ((emacs "24"))
;; URL: https://github.com/avelino/ayu-theme
;; Keywords: theme, dark
...
;; Based on
;;
;; TextMate/Sublime: https://github.com/dempfi/ayu


(deftheme ayu "modern theme.")

(let* ((class '((class color) (min-colors 89)))
       (ayu   "#663399")
       (ninja "#333353")

       (base00 (if (display-graphic-p) "#212733" nil)) ;; default background
       (base01 (if (display-graphic-p) "#663399" "#8700d7")) ;; lighter background (status bar)
       (base02 (if (display-graphic-p) "#5C6773" "#666666")) ;; selection background
       (base03 (if (display-graphic-p) "#5C6773" "#666666")) ;; comments, invisibles
       (base04 (if (display-graphic-p) "#a0a0c5" "#8787af")) ;; dark foreground (status bar)
       (base05 (if (display-graphic-p) "#CCC9C2" "#e4e4e4")) ;; default foreground
       (base06 (if (display-graphic-p) "#EEEEEE" "#FFFFFF")) ;; light foreground
       (base07 (if (display-graphic-p) "#53495d" "#4e4e4e")) ;; light background
       (base08 (if (display-graphic-p) "#CCC9C2" "#cccccc")) ;; variables
       (base09 (if (display-graphic-p) "#FFA759" "#ff9933")) ;; constants
       (base0A (if (display-graphic-p) "#BAE67E" "#ccffcc")) ;; search text background
       (base0B (if (display-graphic-p) "#BAE67E" "#ccffcc")) ;; strings
       (base0C (if (display-graphic-p) "#95E6CB" "#99ffcc")) ;; regex, escaped chars
       (base0D (if (display-graphic-p) "#FFD580" "#ffcc99")) ;; functions
       (base0E (if (display-graphic-p) "#7aa5ff" "#5fafff")) ;; keywords
       (base0F (if (display-graphic-p) "#FFFFFF" "#FFFFFF")) ;; deprecations / background: base09
  ...
  (custom-theme-set-faces
   ...
   `(magit-diff-hunk-heading-highlight ((,class (:background ,ayu))))
   `(magit-hunk-heading           ((,class (:background ,bg4))))
   `(magit-hunk-heading-highlight ((,class (:background ,ayu))))
   ...
   ;; mode-line
   `(mode-line ((,class (:foreground ,type :background ,ayu))))
   ...
   `(powerline-fileinfo-normal ((t (:weight bold :foreground ,base06 :background ,ayu))))
   ...
   ;; spacemacs
   `(spacemacs-normal ((,class (:background ,ayu))))
